 ...
 */ //@ts-ignore
export const scraper_kotobukiya = async (driver, SKU: string) => {
  try {
    //* naivgate to the first website
    await driver.get("https://shop.kotobukiya.co.jp/shop/");
    ...
    console.log(`SKU ${SKU} was not found on https://shop.kotobukiya.co.jp/shop/`);
